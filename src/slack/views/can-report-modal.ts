    ...
    return {
      ...
      blocks: [
        ...
        plainTextInput(
          "Actions",
          "actions",
          "What actions are currently being taken to resolve the incident?",
          true
        ),
        plainTextInput(
          "Needs",
          "needs",
          "What things do we need to do next?",
          true
        ),
        inputBlock(
          "Time to next report...",
          "next-report",
          actionStaticSelect("Select a deadline", "next-report", [
            option("5 minutes", "5"),

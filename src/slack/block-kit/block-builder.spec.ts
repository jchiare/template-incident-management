...
import {
  ...
  actions,
  plainTextInput,
  actionSelectExternal,
  sectionWithFields,
  sectionWithButton,
  URLButton,
  sectionWithExternalSelect,
  sectionWithImage
} from "./block-builder";
...
describe("Block builder", () => {
  describe("sections", () => {
    ...
    describe("sectionWithOverflow", () => {
      it("returns a formatted section block containing the provided text and an overflow", () => {
        ...
        const actualValue = sectionWithOverflow(
          testText,
          [option(testText, testValue)],
          testValue
        );
        const expectedValue = {
          type: "section",
    ...
    describe("sectionWithButton", () => {
      it("returns a formatted section block containing the provided text and an overflow", () => {
        ...
        const actualValue = sectionWithButton(
          testText,
          actionButton(testButtonText, undefined, undefined, testButtonValue),
          testBlockID
        );
        const expectedValue = {
          type: "section",
    ...
    describe("sectionWithExternalSelect", () => {
      it("returns a formatted section block containing the provided text and an external select", () => {
        ...
        const testSelectExternal = actionSelectExternal(
          testPlaceholder,
          testActionID,
          testInitialOption
        );
        const actualValue = sectionWithExternalSelect(
          testText,
          testSelectExternal,
          testBlockID
        );
  ...
  describe("actionSelectExternal", () => {
    ...
    it("returns a externally powered select block with the initial option set", () => {
      ...
      const testActionID = "action_id_123";
      const testInitialOption = "Initial Option";
      const actualValue = actionSelectExternal(
        testPlaceholder,
        testActionID,
        testInitialOption
      );
  ...
  describe("input", () => {
    it("returns a single line input block", () => {
      ...
      const testBlockID = "TestBlockID";
      const actualValue = plainTextInput(
        testTitle,
        testBlockID,
        testPlaceholder
      );
